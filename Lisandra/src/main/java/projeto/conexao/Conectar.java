...
public class Conectar {
    ...
    public Conectar inserirProcessos(Integer pid){
        try {
            Class.forName("com.mysql.jdbc.Driver");
            Connection conexao = DriverManager.getConnection(url, user, passwd);
            ...
            instrucao.setString(1, "Processos");
            instrucao.setDouble(2, pid);
//            instrucao.setDouble(3, usoMem);
//            instrucao.setDouble(4, usoDisk);
